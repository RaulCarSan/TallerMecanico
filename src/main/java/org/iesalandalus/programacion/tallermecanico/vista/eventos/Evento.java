...
public enum Evento {
    ...
    BUSCAR_TRABAJO(31, "Buscar una trabajo."),
    BORRAR_TRABAJO(32,"Borrar una trabajo."),
    LISTAR_TRABAJOS(33,"Listar trabajos."),
    LISTAR_TRABAJOS_CLIENTE(34,"Listar trabajos de un cliente."),
    LISTAR_TRABAJOS_VEHICULO(35,"Listar trabajos de un vehiculo."),
    ...
    MOSTRAR_ESTADISTICAS_MENSUALES(50,"Mostar las estadisticas mensuales."),
    SALIR(0,"Salir.");
